...
export const BigPeach = Template.bind({});
BigPeach.args = {
    view: ArticleView.BIG,
    article,
};
BigPeach.decorators = [ThemeDecorator(Theme.PEACH)];

export const SmallPeach = Template.bind({});
SmallPeach.args = {
    view: ArticleView.SMALL,
    article,
};
SmallPeach.decorators = [ThemeDecorator(Theme.PEACH)];
